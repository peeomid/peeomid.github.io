...
layout: single
title: "tmd (todos.md)"
excerpt: "Terminal-based Markdown todo manager with filters, TUI, and JSON output for automation."
---
...
- Anyone who wants task queries like `bucket:today` or `energy:low`.
